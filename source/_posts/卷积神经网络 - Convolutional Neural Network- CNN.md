...
* CNN可以学到**模式的空间层次结构**
    ...
    * ![图 1.2](/images/cnn-20190422/02.png)
...
![图 5.1](/images/cnn-20190422/03.png)
...
* 输出的宽度和高度可能与输入的宽度和高度不同。不同的原因可能有两点。
    ...
    * **Gif动图**说明。
    * 
    ![图 5.4](/images/cnn-20190422/01.gif)
    ![图 5.5](/images/cnn-20190422/02.gif)
    ![图 5.6](/images/cnn-20190422/03.gif)
...
* 需要注意的是，不能增强验证数据
* ![图 2.2.1](/images/cnn-20190422/06.png)
...
* ![图 3.3.1](/images/cnn-20190422/07.png)
* 特征提取有两种方法
    * 不使用数据增强的快速特征提取
...
![图 3.3.2](/images/cnn-20190422/08.png)
...
![](/images/cnn-20190422/10.png)
![](/images/cnn-20190422/11.png)
